...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2023 at 09:44 PM
...
(148, 'Alun-alun Kota wonosobo', 3, 1, 0, 0),
...
(148, 'Alun-alun Kota wonosobo', 0, 1, 0, 0),
...
(148, 'Alun-alun Kota wonosobo', 'Sosial_Budaya', 0, 1, 0),
...
(148, 'Alun-alun Kota wonosobo', 60000, 0, 0, 1),
(149, 'Alun-alun Kota Tegal', 68000, 0, 0, 1);
...
('https://kamini.id/wp-content/uploads/2020/12/macam-macam-warna-biru_thumbnail-Copy.jpg', 'white', 'Dengan Fuzzy Logic Tahani');
...
('Alun-alun Kota wonosobo', 148, 'Sosial_Budaya', 0, 0, 3, 60000),
('Alun-alun Kota Tegal', 149, 'Sosial_Budaya', 0, 16, 3, 68000);
...
--
ALTER TABLE `input_user_tb`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1148;
